...
exports.ReorderReceiptRuleSetCommand = exports.$Command = void 0;
...
class ReorderReceiptRuleSetCommand extends smithy_client_1.Command
    ...
    .f(void 0, void 0)
    .ser(Aws_query_1.se_ReorderReceiptRuleSetCommand)
    .de(Aws_query_1.de_ReorderReceiptRuleSetCommand)
    .build() {
}
