...
exports.ListVerifiedEmailAddressesCommand = exports.$Command = void 0;
...
class ListVerifiedEmailAddressesCommand extends smithy_client_1.Command
    ...
    .f(void 0, void 0)
    .ser(Aws_query_1.se_ListVerifiedEmailAddressesCommand)
    .de(Aws_query_1.de_ListVerifiedEmailAddressesCommand)
    .build() {
}
